...
export default {
  ...
  theme: {
    extend: {
      ...
      animation: {
        fade01: 'fadeIn 0.1s ease-in-out',
        fade02: 'fadeIn 0.2s ease-in-out',
        fade05: 'fadeIn 0.5s ease-in-out',
        fade1: 'fadeIn 1s ease-in-out',
        slideIn01: 'slideIn 0.1s ease-in-out forwards',
        slideIn02: 'slideIn 0.2s ease-in-out forwards',
        slideIn05: 'slideIn 0.5s ease-in-out forwards',
        slideIn1: 'slideIn 1s ease-in-out forwards',
        slideOut01: 'slideOut 0.1s ease-in-out forwards',
        slideOut02: 'slideOut 0.2s ease-in-out forwards',
        slideOut05: 'slideOut 0.5s ease-in-out forwards',
        slideOut1: 'slideOut 1s ease-in-out forwards'
      },
